...
function(hazel_export)
    ...
    if(arg_TARGETS)
        ...
        foreach(target IN LISTS arg_TARGETS)
            ...
            foreach(pkg IN LISTS HAZEL_IMPORTED_PACKAGES)
                ...
                endforeach()
            endforeach()
            hazel_get_property(HAZEL_PACKAGE_IMPORTED_TARGETS)
            foreach(dep IN LISTS depends)
    ...
    if(arg_EXPORT)
        hazel_get_property(HAZEL_PACKAGE_EXPORTS)
...
macro(_hazel_export_cmake_scripts)
    ...
    foreach(script IN ITEMS ${ARGN})
        ...
        hazel_get_property(HAZEL_PACKAGE_EXPORTED_CMAKE_FILES)
        if(script_name IN_LIST HAZEL_PACKAGE_EXPORTED_CMAKE_FILES)
            message(SEND_ERROR "package '${PROJECT_NAME}' installs CMake script '${script_name}' more than once")
            continue()
        endif()
        set(devel_script)
        set(install_script)
