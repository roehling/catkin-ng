...
##############################################################################
#
# package version file generated by the Hazel Build System
# Copyright 2020-2021 Timo Röhling <timo@@gaussglocke.de>
#
...
##############################################################################
@{
if HAZEL_PACKAGE_COMPATIBILITY == "SemanticVersion":
...
@[else]@
    message(AUTHOR_WARNING
        "Package '${PACKAGE_FIND_NAME}' declares itself incompatible "
        "across different versions, so version ranges in find_package() "
        "are ignored. The lower end of the version range is used to "
        "test compatibility."
    )
@[end if]@
endif()
