...
if(DEFINED CATKIN_INSTALL_PREFIX AND NOT DEFINED HAZEL_INSTALL_PREFIX)
    set(HAZEL_INSTALL_PREFIX "${CATKIN_INSTALL_PREFIX}")
endif()
...
if(PROJECT_NAME STREQUAL "hazel")
    set(ENV{PYTHONPATH} "${PROJECT_SOURCE_DIR}/src:$ENV{PYTHONPATH}")
endif()
