...
function(hazel_python_setup)
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/setup.py")
        ...
        install(CODE "execute_process(WORKING_DIRECTORY \"${CMAKE_CURRENT_SOURCE_DIR}\" COMMAND ${HAZEL_PYTHON_EXECUTABLE} setup.py build -b \"${CMAKE_CURRENT_BINARY_DIR}/python-setup/build\" egg_info -e \"${CMAKE_CURRENT_BINARY_DIR}/python-setup/egg-info\" install ${HAZEL_PYTHON_LAYOUT} --root \"\$ENV{DESTDIR}/\" --prefix \"${CMAKE_INSTALL_PREFIX}\")")
    else()
