...
def prepare_args(parser):
    ...
    parser.add_argument("--main", action="store_true", help="use CATKIN_PACKAGE as prefix instead of <package_name>")
...
def run(args):
    try:
        ...
        if args.cmake:
            prefix = "CATKIN_PACKAGE" if args.main else f"{package.name}"
            output_cmake_property("CATKIN_PACKAGE_NAME", package.name)
