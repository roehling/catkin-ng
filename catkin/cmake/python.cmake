...
function(catkin_python_setup)
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/setup.py")
        ...
        configure_file("${CATKIN_CMAKE_DIR}/python-install.cmake.in" "${CMAKE_CURRENT_BINARY_DIR}/catkin-generated/python_install.cmake" @ONLY)
        install(SCRIPT "${CMAKE_CURRENT_BINARY_DIR}/catkin-generated/python_install.cmake")
    else()
